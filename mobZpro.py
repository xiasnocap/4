        ...
        if op.type == 13 or op.type == 124:
            ...
            if M001D23 in op.param3:
                if settings["autoJoin"] == True:
                    if op.param2 in creator or op.param2 in owner or op.param2 in admin or op.param2 in staff or op.param2 in Bots or op.param2 in mybots:
                        a001.acceptGroupInvitation(op.param1)
                    else:
                        a001.rejectGroupInvitation(op.param1)
            if M002D23 in op.param3:
                if settings["autoJoin"] == True:
                    if op.param2 in creator or op.param2 in owner or op.param2 in admin or op.param2 in staff or op.param2 in Bots or op.param2 in mybots:
                        a002.acceptGroupInvitation(op.param1)
                    else:
                        a002.rejectGroupInvitation(op.param1)
            ...
            if op.param1 in status["promax"]:
                if op.param2 in status["blacklist"]:
                    if op.param2 in creator or op.param2 in owner or op.param2 in admin or op.param2 in staff or op.param2 in Bots or op.param2 in mybots:
                        ...
                        try:
                            d23X_38 = threading.Thread(target=kick, args=(op.param1, op.param2)).start()
                        except:
                            pass
        if op.type == 19 or op.type == 133:
            ...
            if op.param1 in status["promax"]:
                if op.param2 in creator or op.param2 in owner or op.param2 in admin or op.param2 in staff or op.param2 in Bots or op.param2 in mybots:
                    ...
                    d23X_39 = threading.Thread(target=blacklist, args=(op.param2,)).start()
                    try:
                        d23X_40 = threading.Thread(target=kick, args=(op.param1, op.param2)).start()
                        d23X_41 = threading.Thread(target=invite, args=(op.param1, op.param3)).start()
                    except:
                        pass
            if op.param3 in M001D23:
                if op.param2 in creator or op.param2 in owner or op.param2 in admin or op.param2 in staff or op.param2 in Bots or op.param2 in mybots:
                    ...
                    try:
                        ...
                        d23X_44 = threading.Thread(target=backup, args=(op.param1, op.param3)).start()
                        d23X_45 = threading.Thread(target=antijs, args=(op.param1, op.param2)).start()
            ...
            if op.param3 in M002D23:
                if op.param2 in creator or op.param2 in owner or op.param2 in admin or op.param2 in staff or op.param2 in Bots or op.param2 in mybots:
                    ...
                    d23X_47 = threading.Thread(target=blacklist, args=(op.param2,)).start()
                    try:
                        d23X_48 = threading.Thread(target=kick, args=(op.param1, op.param2)).start()
                        d23X_49 = threading.Thread(target=backup, args=(op.param1, op.param3)).start()
                        d23X_50 = threading.Thread(target=antijs, args=(op.param1, op.param2)).start()
            ...
            if op.param3 in M003D23:
                if op.param2 in creator or op.param2 in owner or op.param2 in admin or op.param2 in staff or op.param2 in Bots or op.param2 in mybots:
                    ...
                    d23X_52 = threading.Thread(target=blacklist, args=(op.param2,)).start()
                    try:
                        d23X_53 = threading.Thread(target=kick, args=(op.param1, op.param2)).start()
                        d23X_54 = threading.Thread(target=invite, args=(op.param1, op.param3)).start()
            ...
            if op.param3 == M001D23:
                if op.param2 in creator or op.param2 in owner or op.param2 in admin or op.param2 in staff or op.param2 in Bots or op.param2 in mybots:
                    ...
                    try:
                        ...
                        d23X_61 = threading.Thread(target=backup, args=(op.param1, op.param3)).start()
                    except:
                        pass
            ...
            if op.param3 == M003D23:
                if op.param2 in creator or op.param2 in owner or op.param2 in admin or op.param2 in staff or op.param2 in Bots or op.param2 in mybots:
                    ...
                    try:
                        ...
                        d23X_67 = threading.Thread(target=invite, args=(op.param1, op.param3)).start()
                    except:
                        pass
                        ...
                        if hlth == "help":
                            ...
                            if sender in creator or sender in owner:
                                ...
                                for target in targets:
                                    if target in creator or target in owner or target in admin or target in staff or target in Bots or target in mybots:
                                        ...
                                        try:
                                            d23X_68 = threading.Thread(target=kick, args=(receiver, target)).start()
                                        except:
                                            pass
                            ...
                            if sender in creator or sender in owner:
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    ...
                                    for ls in lists:
                                        try:
                                            d23X_69 = threading.Thread(target=invite, args=(receiver, ls)).start()
                                        except:
                                            pass
